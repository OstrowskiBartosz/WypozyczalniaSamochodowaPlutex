...
<li>
                ...
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Zatwierdzone</a>
                           <div class="clearfix"></div>
        </div>

              <?php } else if($result->Status==2) { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Anulowane</a>
            <div class="clearfix"></div>
        </div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Czekaj na zatwier.</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
       <div style="float: left"><p><b>Wiadomosc:</b> <?php echo htmlentities($result->message);?> </p></div>
              </li>
              <?php }} ?>
