...
<html lang="en">
    ...
    <body>
		...
		<div class="txtb">
			<label>Imię :</label>
			<input type="text" name="" value="" placeholder="Wpisz swoję imię">
		</div>
		
		<div class="txtb">
			<label>Email :</label>
			<input type="text" name="" value="" placeholder="Wpisz swój Email">
		</div>
		
		<div class="txtb">
			<label>Numer telefonu :</label>
			<input type="text" name="" value="" placeholder="Wpisz swój numer telefonu">
		</div>
